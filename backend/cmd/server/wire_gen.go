...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openCodeProxyPoolRepository := repository.NewOpenCodeProxyPoolRepository(db)
	openCodeProxyPoolService := service.ProvideOpenCodeProxyPoolService(openCodeProxyPoolRepository, secretEncryptor, settingRepository, accountRepository, groupRepository, apiKeyAuthCacheInvalidator)
	adminService := service.NewAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, openCodeProxyPoolService, channelService)
	...
	accountStatusCheckService := service.NewAccountStatusCheckService(adminService, accountTestService, rateLimitService)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, accountStatusCheckService)
	...
	proxyHandler := handler.ProvideAdminProxyHandler(adminService, openCodeProxyPoolService)
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, userMessageQueueService, configConfig, settingService, coordinator, openCodeProxyPoolService)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator, openCodeProxyPoolService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, openCodeProxyPoolService, redisClient)
