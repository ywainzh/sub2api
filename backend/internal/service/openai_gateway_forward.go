...
func shouldForwardOpenAIResponsesViaRawChatCompletions(account *Account) bool {
	// OpenCode Zen is a Chat Completions-only provider, so it must always use
	// the raw Chat Completions fallback regardless of the probe result or an
	// administrator override (release automation invariant).
