...
```bash
curl -sSL https://raw.githubusercontent.com/ywainzh/sub2api/release/deploy/install.sh | sudo bash
```
...
# Uninstall
curl -sSL https://raw.githubusercontent.com/ywainzh/sub2api/release/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/ywainzh/sub2api/release/deploy/docker-deploy.sh | bash
...
git clone --branch release https://github.com/ywainzh/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.com/#ywainzh/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=ywainzh/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=ywainzh/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=ywainzh/sub2api&type=Date" />
 </picture>
</a>
