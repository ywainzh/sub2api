export default {
    ...
    proxies: {
      ...
      openCode: {
        ...
        disabled: 'Disabled',
        enablePool: 'Enable worker pool',
        includeServerDirect: 'Include server direct',
        workerConcurrency: 'Worker concurrency',
        upstreamKeyOptional: 'Shared upstream key (optional)',
        keepUpstreamKey: 'Leave blank to keep the current key',
        keylessPlaceholder: 'Leave blank for keyless requests',
        clearUpstreamKey: 'Clear and switch to keyless',
        reconcile: 'Reconcile now',
        reconcileSuccess: 'Worker pool reconciliation completed',
        worker: 'Worker',
