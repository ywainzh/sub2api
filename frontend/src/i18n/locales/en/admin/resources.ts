export default {
    ...
    proxies: {
      ...
      openCode: {
		...
		importing: 'Importing and probing…',
		importDialogTitle: 'Import OpenCode nodes',
		proxyFile: 'Proxy file',
		importSourceName: 'Source name',
		importSourceNameHint: 'Uses the file name by default',
		importValidity: 'Validity',
		neverExpires: 'Never expires',
		days: 'days',
		expiresAt: 'Expires at',
		importExpirationHint: 'At expiry, workers stop, egress leases are released, and this source’s nodes and proxy records are deleted.',
        ...
        lastSync: 'Last sync',
        sync: 'Sync now',
        savedSyncFailed: 'Subscription saved, but the initial sync failed: {error}',
		...
		jobCompleted: 'Job complete: {healthy} healthy, {failed} failed, {rateLimited} rate limited, {duplicate} duplicate exits',
		jobFailed: 'Job failed',
		directHttp: 'Direct HTTP',
		failureCount: '{count} consecutive failures',
		retryAt: 'Automatic retry at {time}',
		quarantined: 'Long-term unavailable',
		deleteNode: 'Delete this node',
		deleteNodeConfirm: 'Delete node "{name}"? It will stop scheduling and the same subscription will not add it again.',
		nodeDeleted: 'Node deleted; reloading configuration in the background',
        unprobed: 'Not probed',
        missing: 'Missing',
        probeAll: 'Probe all',
        probe: 'Probe',
        probeNode: 'Probe this node only (sends one minimal Zen request)',
        probing: 'Probing…',
        probeInProgress: 'Probing {count} nodes',
		probeProgressHint: 'Up to 10 nodes are probed in the background and continue if you leave this page; {seconds}s elapsed.',
        probeCompleted: 'Probe complete: {healthy} healthy, {rateLimited} rate limited, {duplicate} duplicate exits, {failed} other failures ({seconds}s)',
        exitIp: 'Exit IP',
        region: 'Region',
        lastProbe: 'Last probe',
        poolStatus: 'Worker pool status',
        activeWorkers: 'Schedulable workers',
        upstreamKey: 'Upstream key',
        keyConfigured: 'Configured',
        keyless: 'Keyless',
        serverDirect: 'Server direct',
        pending: 'Pending reconcile',
        disabled: 'Disabled',
        modelRegistry: 'Model registry',
        modelRegistryCount: '{count} models',
        modelRegistryBaseline: 'Built-in baseline',
        modelRegistryLive: 'Live upstream',
        modelRegistryFetchedAt: 'Fetched {time}',
        modelRegistryBaselineHint: 'Upstream model list could not be fetched; falling back to the built-in baseline',
        modelRegistryEmpty: 'Registry is empty',
        modelRegistryRefreshed: 'Model registry refreshed',
        subscriptionColumn: 'Subscription',
        allSubscriptions: 'All subscriptions',
        inactiveNodes: 'Inactive',
        nodeBreakdownHint: 'Healthy / failed / inactive',
        nodeDeleteFollowUpDone: 'Background reload and reconcile finished',
        nodeDeleteFollowUpFailed: 'Background reload failed: {error}',
        nodeDeleteFollowUpSlow: 'Still processing in the background; refresh later to see the result',
        worker: 'Worker',
        workerActive: 'Schedulable',
        workerCooling: 'Cooling',
