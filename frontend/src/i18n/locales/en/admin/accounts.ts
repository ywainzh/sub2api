export default {
    accounts: {
      ...
      statusCheck: {
        ...
        description: 'Test every account in an OpenAI group with live logs and categorized results.',
        configuration: 'Check configuration',
        groupLabel: 'OpenAI group',
        groupPlaceholder: 'Select a group',
        groupHint: 'Inactive groups are included; every non-deleted account in the group is checked.',
        inactiveGroup: 'Inactive',
        noGroups: 'No OpenAI groups',
        noGroupsHint: 'Create an OpenAI group and assign accounts in Group Management first.',
        modelLabel: 'Test model',
        modelPlaceholder: 'Select or enter a model',
        modelHint: 'Defaults to gpt-5.5. You can also enter a model ID manually.',
        useCustomModel: 'Use model: ',
        modeLabel: 'Test mode',
        modeHint: 'Default sends the standard probe; Compact uses /responses/compact.',
        workerHint: 'Fixed concurrency: {count}. Leaving the page or stopping cancels unfinished requests.',
        start: 'Check all accounts',
        stop: 'Stop check',
        ...
        copyLogs: 'Copy logs',
        logsCopied: 'Status check logs copied',
        unknownAccount: 'Unknown account',
        loadGroupsFailed: 'Failed to load OpenAI groups',
        loadModelsFailed: 'Failed to load model candidates',
        requestFailed: 'Status check request failed',
        runState: {
          idle: 'Ready',
          running: 'Running',
          completed: 'Completed',
        ...
        log: {
          connecting: 'Opening the status check stream...',
          batchStart: 'Checking group "{group}": {total} accounts, model {model}, mode {mode}',
          accountStart: 'Check started (priority {priority})',
