export default {
    accounts: {
      ...
      statusCheck: {
        title: '账号状态检测',
        description: '按 OpenAI 分组批量检测账号连接状态，并实时查看日志与分类统计。',
        configuration: '检测配置',
        groupLabel: 'OpenAI 分组',
        groupPlaceholder: '请选择分组',
        groupHint: '包含停用分组；检测会覆盖分组内所有未删除账号。',
        inactiveGroup: '已停用',
        noGroups: '暂无 OpenAI 分组',
        noGroupsHint: '请先在分组管理中创建 OpenAI 分组并关联账号。',
        modelLabel: '测试模型',
        modelPlaceholder: '选择或输入模型',
        modelHint: '默认使用 gpt-5.5，也可以手动输入模型 ID。',
        useCustomModel: '使用模型：',
        modeLabel: '测试模式',
        modeHint: '常规请求用于标准连通性检测；Compact 使用 /responses/compact 探测。',
        workerHint: '固定并发 {count}，离开页面或停止检测会取消未完成请求。',
        start: '一键检测',
        stop: '停止检测',
        summary: '实时统计',
        totalProgress: '总账号 / 完成进度',
        normal: '正常',
        unauthorized: '401',
        ...
        loadModelsFailed: '加载模型候选失败',
        requestFailed: '状态检测请求失败',
        runState: {
          idle: '等待检测',
          running: '检测中',
          completed: '检测完成',
        ...
        category: {
          ...
          quota_exhausted: '429 / 额度不足',
          forbidden: '403 / 禁止访问',
          other_error: '其他错误'
        },
        log: {
          connecting: '正在建立状态检测流...',
          batchStart: '开始检测分组“{group}”：共 {total} 个账号，模型 {model}，模式 {mode}',
          accountStart: '开始检测（优先级 {priority}）',
