export default {
    ...
    proxies: {
      ...
      openCode: {
        ...
        pending: '待对账',
        disabled: '已关闭',
        enablePool: '启用 Worker 池',
        includeServerDirect: '包含服务器直连',
        workerConcurrency: '单 Worker 并发',
        upstreamKeyOptional: '统一上游 Key（可选）',
        keepUpstreamKey: '留空保持现有 Key',
        keylessPlaceholder: '留空使用 Keyless 请求',
        clearUpstreamKey: '清除并切回 Keyless',
        reconcile: '立即对账',
        reconcileSuccess: 'Worker 池对账完成',
        worker: 'Worker',
        workerActive: '可调度',
        workerCooling: '冷却中',
        workerInactive: '已停用'
