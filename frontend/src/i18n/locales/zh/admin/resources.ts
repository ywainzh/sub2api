export default {
    ...
    proxies: {
      ...
      openCode: {
        standardTab: '普通代理',
        subscriptionsTab: 'OpenCode 订阅',
        nodesTab: 'OpenCode 节点',
        addSubscription: '添加订阅',
		importNodes: '导入节点',
		importing: '正在导入并探测…',
		importDialogTitle: '导入 OpenCode 节点',
		proxyFile: '代理文件',
		importSourceName: '来源名称',
		importSourceNameHint: '默认使用文件名',
		importValidity: '有效期',
		neverExpires: '永不过期',
		days: '天',
		expiresAt: '到期时间',
		importExpirationHint: '到期后自动停止 Worker、释放出口租约，并删除该来源的节点和代理记录。',
		startImport: '开始导入',
        ...
        lastSync: '最近同步',
        sync: '立即同步',
        savedSyncFailed: '订阅已保存，但首次同步失败：{error}',
        deleteConfirm: '确定删除订阅“{name}”吗？',
        probeAll: '批量探测',
        probe: '探测',
        probeNode: '单独探测此节点（会发送一次最小 Zen 请求）',
        probing: '探测中…',
        probeInProgress: '正在探测 {count} 个节点',
		probeProgressHint: '后台最多并发探测 10 个节点，可离开页面后继续执行；已用时 {seconds} 秒',
        probeCompleted: '探测完成：健康 {healthy}，429 {rateLimited}，重复出口 {duplicate}，其他失败 {failed}（{seconds} 秒）',
        allHealth: '全部健康状态',
        healthy: '健康',
        transportError: '传输失败',
        authError: '认证失败',
		...
		jobCompleted: '任务完成：健康 {healthy}，失败 {failed}，429 {rateLimited}，重复出口 {duplicate}',
		jobFailed: '任务执行失败',
		directHttp: 'HTTP 直连',
		...
		quarantined: '长期不可用',
		deleteNode: '删除此节点',
		deleteNodeConfirm: '确定删除节点“{name}”吗？该节点将停止调度，并且不会被同一订阅自动重新添加。',
		nodeDeleted: '节点已删除，正在后台重载配置',
        unprobed: '未探测',
        missing: '节点已消失',
        exitIp: '出口 IP',
        region: '地区',
        lastProbe: '最近探测',
        poolStatus: 'Worker 池状态',
        activeWorkers: '可调度 Worker',
        upstreamKey: '上游 Key',
        keyConfigured: '已统一配置',
        keyless: 'Keyless',
        serverDirect: '服务器直连',
        ...
        disabled: '已关闭',
        modelRegistry: '模型注册表',
        modelRegistryCount: '{count} 个模型',
        modelRegistryBaseline: '内置基线',
        modelRegistryLive: '上游实时',
        modelRegistryFetchedAt: '{time} 抓取',
        modelRegistryBaselineHint: '上游模型列表抓取失败，当前回退到内置基线',
        modelRegistryEmpty: '注册表为空',
        modelRegistryRefreshed: '模型注册表已刷新',
        subscriptionColumn: '所属订阅',
        allSubscriptions: '全部订阅',
        inactiveNodes: '已停用',
        nodeBreakdownHint: '健康 / 失败 / 已停用',
        nodeDeleteFollowUpDone: '后台重载与对账已完成',
        nodeDeleteFollowUpFailed: '后台重载失败：{error}',
        nodeDeleteFollowUpSlow: '后台仍在处理，稍后刷新可查看结果',
        worker: 'Worker',
        workerActive: '可调度',
        workerCooling: '冷却中',
        workerInactive: '已停用'
