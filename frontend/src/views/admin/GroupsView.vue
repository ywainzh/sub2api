  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <div v-if="exposeAdvancedGroupFeatures && isProfitControlPlatform(createForm.platform)" class="border-t pt-4">
          <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            <input
        ...
        <div
          v-if="exposeAdvancedGroupFeatures && createForm.platform === 'openai'"
          class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
    ...
    >
      ...
      >
        ...
        <!-- 分组利润控制（五个平台 token 请求） -->
        <div v-if="exposeAdvancedGroupFeatures && isProfitControlPlatform(editForm.platform)" class="border-t pt-4">
          <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            <input
        ...
        <!-- OpenAI Live 开关（仅 openai 平台） -->
        <div
          v-if="exposeAdvancedGroupFeatures && editForm.platform === 'openai'"
          class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.openaiLive.title") }}
...
const exposeAdvancedGroupFeatures = false;
...
onMounted(() => {
  loadGroups();
  if (exposeAdvancedGroupFeatures) {
