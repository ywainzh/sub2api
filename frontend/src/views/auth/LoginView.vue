    ...
    <div class="space-y-6">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <LoginAgreementPrompt
          v-if="exposeOptionalAuthFeatures && loginAgreementEnabled"
...
const exposeOptionalAuthFeatures = false
...
const agreementGateActive = computed(
  () => exposeOptionalAuthFeatures && loginAgreementEnabled.value && !agreementAccepted.value
)
...
const showPasskeyLogin = computed(
  () => exposeOptionalAuthFeatures && passkeyEnabled.value && typeof window.PublicKeyCredential !== 'undefined'
)
