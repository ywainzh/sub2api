...
| `lite/AGENT_RUNBOOK.md` | `release` 分支发布、阿里云生产升级与回滚的 Agent 固定流程 |
...
curl -sSL https://raw.githubusercontent.com/ywainzh/sub2api/release/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/ywainzh/sub2api/releases)
