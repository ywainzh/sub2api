...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/ywainzh/sub2api/release/deploy/install.sh | bash
#
...
Documentation=https://github.com/ywainzh/sub2api
